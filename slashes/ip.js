...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('ip') //Name des Befehls - BENENNEN SIE DIE DATEI AUCH UM!!!
        .setDescription(`Sendet die IP-Adresse des Servers`) //Beschreibung des Befehls - Sie können ihn ändern :)
};
