...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('version') //Name des Befehls - BENENNEN SIE DIE DATEI AUCH UM!!!
        .setDescription(`Sendet die Minecraft-Version des Servers`) //Beschreibung des Befehls - Sie können ihn ändern :)
};
