...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('list') //Name des Befehls - BENENNEN SIE DIE DATEI AUCH UM!!!
        .setDescription('Sendet die aktuelle Liste der Spieler online') //Beschreibung des Befehls - Sie können itv ändern :)
};
...
module.exports.run = async (bot, interaction) => {
    ...
    if (server.type === 'java') {
        ...
        interaction.reply({ content: 'Es tut uns leid, aber diese Funktion funktioniert nicht für Bedrock-Server.' });
    }
