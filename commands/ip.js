...
module.exports.config = {
    name: "ip", //Name des Befehls - BENENNEN SIE DIE DATEI AUCH UM!!!
    description: "Sends the IP address of server", //Beschreibung des Befehls - Sie können ihn ändern :)
    aliases: commands.ip.aliases //Aliasnamen des Befehls - setzen Sie sie in config.js
};
