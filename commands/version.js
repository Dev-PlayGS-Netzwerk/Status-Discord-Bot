...
module.exports.config = {
    name: "version", //Name des Befehls - BENENNEN SIE DIE DATEI AUCH UM!!!
    description: "Sendet die Minecraft-Version des Servers", //Beschreibung des Befehls - Sie können ihn ändern :)
    aliases: commands.version.aliases //Aliasnamen des Befehls - setzen Sie sie in config.js
};
...
module.exports.run = async (bot, message, args) => {
    ...
    if (server.type === 'java') {
        try {
            ...
            if (warns) console.log(`${bot.emotes.warn} ` + warn(`Version vom Server konnte nicht abgerufen werden! Abrufen aus der Config ..`));
